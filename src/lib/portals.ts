...
export const PORTALS: PortalDef[] = [
  ...
  { slug: "trainer", label: "Trainer Portal", icon: "fa-graduation-cap", tint: "bg-purple-600", roles: ["TRAINER", "SUPER_ADMIN"] },
  { slug: "qc", label: "QC Portal", icon: "fa-magnifying-glass-chart", tint: "bg-rose-600", roles: ["QC_MANAGER", "QC_REVIEWER", "SUPER_ADMIN"] },
